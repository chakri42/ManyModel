...
$WebClient.DownloadFile("https://codeload.github.com/MSUSSolutionAccelerators/Risk-Classification-and-Load-Modeling-Solution-Accelerator/zip/refs/heads/main","C:\AllFiles\AllFiles.zip")
...
#Download LogonTask
$WebClient = New-Object System.Net.WebClient
$WebClient.DownloadFile("https://experienceazure.blob.core.windows.net/templates/covid-19-vaccine-proof/scripts/logon.ps1","C:\LabFiles\logon.ps1")
